                        ...
                        e("<li/>")
                            ...
                            .append(
                                e('<div class="dt-autofill-button">').append(
                                    e('<button class="' + j.classes.btn + '">' + a.i18n("autoFill.button", "&gt;") + "</button>").on("click", function () {
...
(function (f) {
    ...
    var i = function (a, b) {
        ...
        this.s = { dt: null, init: f.extend(!0, {}, i.defaults, b), fixed: 0, fixedRight: 0, reorderCallback: null, mouse: { startX: -1, startY: -1, offsetX: -1, offsetY: -1, target: -1, targetIndex: -1, fromIndex: -1 }, aoTargets: [] };
    ...
    f.extend(i.prototype, {
        ...
        _fnRegions: function () {
            ...
            for (var b = 0, c = this.s.aoTargets[0].x, e = 0, g = a.length; e < g; e++)
                e != this.s.mouse.fromIndex && b++, a[e].bVisible && "none" !== a[e].nTh.style.display && ((c += f(a[e].nTh).outerWidth()), this.s.aoTargets.push({ x: c, to: b }));
        ...
        _fnCreateDragNode: function () {
            ...
            this.dom.drag = f(g.cloneNode(!1))
                ...
                .css({ position: "absolute", top: 0, left: 0, width: f(b).outerWidth(), height: f(b).outerHeight() })
                .appendTo("body");
    ...
    d.extend(m.prototype, {
        ...
        _fnGridSetup: function () {
            ...
            0 < this.s.iLeftColumns &&
                ((this.dom.grid.left.wrapper = e), (this.dom.grid.left.head = e.childNodes[0]), (this.dom.grid.left.body = e.childNodes[1]), (this.dom.grid.left.liner = d("div.DTFC_LeftBodyLiner", c)[0]), c.appendChild(e));
            ...
            for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
                ...
                for (var l = 0, o = this.s.iTableColumns; l < o; l++)
                    if (-1 !== d.inArray(l, b)) {
                        ...
                        -1 === q ? ((q = d(a[h][l].cell).clone(c, !1)[0]), f.push(q), g.push(a[h][l].cell), k.push({ cell: q, unique: a[h][l].unique })) : k.push({ cell: f[q], unique: a[h][l].unique });
                    }
                e.push(k);
            }
            return e;
    ...
    var o = c.fn.dataTable,
        j = function (b, a) {
            ...
            this.s.dt.settings()[0].responsive ||
                (a && "string" === typeof a.details ? (a.details = { type: a.details }) : a && !1 === a.details ? (a.details = { type: !1 }) : a && !0 === a.details && (a.details = { type: "inline" }),
    ...
    c.extend(j.prototype, {
        ...
        _detailsObj: function (b) {
            ...
            return c.map(this.s.columns, function (c, f) {
                if (!c.never && !c.control) return { title: d.settings()[0].aoColumns[f].sTitle, data: d.cell(b, f).render(a.c.orthogonal), hidden: d.column(f).visible() && !a.s.current[f], columnIndex: f, rowIndex: b };
            });
        },
        _find: function (b) {
        ...
        listHiddenNodes: function () {
            return function (b, a, d) {
                ...
                c.each(d, function (a, d) {
                    d.hidden &&
                        (c('<li data-dtr-index="' + d.columnIndex + '" data-dt-row="' + d.rowIndex + '" data-dt-column="' + d.columnIndex + '"><span class="dtr-title">' + d.title + "</span> </li>")
...
(function (c) {
    ...
    c.extend(g.prototype, {
        ...
        _rowWrap: function (a, b) {
            return ("object" === typeof a && a.nodeName && "tr" === a.nodeName.toLowerCase()
                ? c(a)
...
(function (d) {
    ...
    d.extend(k.prototype, {
        ...
        _mouseMove: function (c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== e)
                0 === e ? this.dom.target.prependTo(j) : ((b = d.unique(i.rows({ page: "current" }).nodes().toArray())), e > this.s.lastInsert ? this.dom.target.insertAfter(b[e - 1]) : this.dom.target.insertBefore(b[e])),
                    this._cachePositions(),
                    (this.s.lastInsert = e);
            this._shiftScroll(c);
        },
    ...
    k.defaults = { dataSrc: 0, editor: null, enable: !0, formOptions: {}, selector: "td:first-child", snapX: !1, update: !0 };
    ...
    e.extend(h.prototype, {
        ...
        fnScrollToRow: function (a, b) {
            ...
            if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== i)
                (d = !0), (f = this.fnRowToPixels(a, !1, !0)), this.s.redrawTop < f && f < this.s.redrawBottom && ((this.s.forceReposition = !0), (b = !1));
            "undefined" == typeof b || b
                ? ((this.s.ani = d),
        ...
        fnMeasure: function (a) {
            ...
            b.row &&
                ((b.viewport = e.contains(j, this.dom.scroller) ? e(this.dom.scroller).height() : this._parseHeight(e(this.dom.scroller).css("height"))),
