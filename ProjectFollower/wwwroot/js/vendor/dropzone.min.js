                    ...
                    value: function () {
                        (this.prototype.Emitter = Emitter),
                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                renameFile: null,
                                forceFallback: !1,
                                dictDefaultMessage: "Yüklenecek dosyaları seçin yada sürükleyip kutucuğun içine bırakın",
                                dictFallbackMessage: "Web sürümünüz dosyayı sürükleyebilmek için yetersiz :(.",
                                dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
                                dictFileTooBig: "Dosya büyütü çok büyük ({{filesize}}MiB). Max dosya boyutu: {{maxFilesize}}MiB.",
                                dictInvalidFileType: "Bu tip bir dosyayı yükleyemezsiniz.",
                                dictResponseError: "Server responded with {{statusCode}} code.",
                                dictCancelUpload: "Upload iptali",
                                dictUploadCanceled: "Upload iptal edildi.",
                                dictCancelUploadConfirmation: "Uploadı iptal etmek istediğine emin misin?",
                                dictRemoveFile: "Dosyayı çıkar",
